...
public class ClassicPlayerController : MonoBehaviour {
	...
	public float airControl = 0.2f;               // How precise air control is
	...
	private void Update() {
		...
		rotX -= Input.GetAxisRaw("Mouse Y") * xMouseSensitivity * Time.deltaTime;
		rotY += Input.GetAxisRaw("Mouse X") * yMouseSensitivity * Time.deltaTime;
	...
	/// it allows players to move side to side much faster
	/// rather than being 'sluggish' when it comes to cornering.
	/// </summary>
