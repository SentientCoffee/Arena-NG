...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class TransformNetworkObject : NetworkObject
	{
		...
		public InterpolateVector3 scaleInterpolation = new InterpolateVector3() { LerpT = 0f, Enabled = false };
		...
		public TransformNetworkObject() : base() { Initialize(); }
		public TransformNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public TransformNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
